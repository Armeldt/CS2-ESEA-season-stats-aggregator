...
def update_gauge_chart(parent, value,value1,value2, title_text, gauge_color, row, column):
    ...
    def update_data(self, analysis_results):
        ...
        if analysis_results:
            ...
            if not round_stats.empty:
                ...
                update_gauge_chart(self.frame_round_type_viz_pistol, winrate_pistol_ct, win_pistol_ct ,total_rounds_ct ,"CT", "#28397f", row=1, column=0)
                ...
                win_pistol_t = int(pistol_terrorist['wins'].values[0])
                total_rounds_t = int(pistol_terrorist['total_rounds'].values[0])
                update_gauge_chart(self.frame_round_type_viz_pistol, winrate_pistol_terrorist,win_pistol_t,total_rounds_t, "T", "#fbac18", row=1, column=1)
                ...
                win_fullbuy_ct = int(fullbuy_ct['wins'].values[0])
                total_fullbuy_ct = int(fullbuy_ct['total_rounds'].values[0])
                update_gauge_chart(self.frame_round_type_viz_fullbuy, winrate_fullbuy_ct,win_fullbuy_ct,total_fullbuy_ct, "CT", "#28397f",row=1, column=0)
                ...
                win_fullbuy_t = int(fullbuy_terrorist['wins'].values[0])
                total_fullbuy_t = int(fullbuy_terrorist['total_rounds'].values[0])
                update_gauge_chart(self.frame_round_type_viz_fullbuy, winrate_fullbuy_terrorist,win_fullbuy_t,total_fullbuy_t, "T", "#fbac18", row=1, column=1)
                ...
                win_forcebuy_ct = int(forcebuy_ct['wins'].values[0])
                total_forcebuy_ct = int(forcebuy_ct['total_rounds'].values[0])
                update_gauge_chart(self.frame_round_type_viz_forcebuy, winrate_forcebuy_ct,win_forcebuy_ct,total_forcebuy_ct, "CT", "#28397f",row=1, column=0)
                ...
                win_forcebuy_t = int(forcebuy_terrorist['wins'].values[0])
                total_forcebuy_t = int(forcebuy_terrorist['total_rounds'].values[0])
                update_gauge_chart(self.frame_round_type_viz_forcebuy, winrate_forcebuy_terrorist,win_forcebuy_t,total_forcebuy_t ,"T", "#fbac18", row=1, column=1)
